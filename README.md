...
To connect your VSR to the TCD, just enter the TCD's hostname - usually "timecircuits" - in the **_Hostname of TCD_** field in the VSR's Config Portal. On the TCD, no special configuration is required. 
