...
- [XH 4pin cables](https://www.amazon.com/HKS-Barrel-Crimping-720PCS-Connectors/dp/B0BY22GRNC/ref=sr_1_7) to connect the Control Board, the Pushwheels and the LED display. Both ends female, with identical assignment (not mirrored)
- [XH 4pin cables](https://www.amazon.com/HKS-Barrel-Crimping-720PCS-Connectors/dp/B0BY22GRNC/ref=sr_1_7) to connect the three buttons ("BUT"/"BUT" pins: shorted by button; "L+"/"L-" pins for light)
